...
(() => {
  ...
  function renderThemeOptions() {
    ...
    entryThemeOptions.className = "yuruneko-theme-list-v19";
    entryThemeOptions.innerHTML = FIXED_THEMES.map((theme) => `
      <label class="yuruneko-theme-card-v19">
        <input
          class="yuruneko-theme-check-v19"
          type="checkbox"
          value="${escapeHtml(theme.name)}"
          ${checkedThemes.includes(theme.name) ? "checked" : ""}
        >
        <span class="yuruneko-theme-copy-v19">
          <strong class="yuruneko-theme-name-v19">
            <span aria-hidden="true">${escapeHtml(theme.icon)}</span>
            <span>${escapeHtml(theme.name)}</span>
          </strong>
          <small class="yuruneko-theme-description-v19">
  ...
  function ensureThemeSelectorStyles() {
    const oldStyle = document.getElementById("themeSelectorStylesV18");
    if (oldStyle) oldStyle.remove();

    if (document.getElementById("themeSelectorStylesV19")) return;

    const style = document.createElement("style");
    style.id = "themeSelectorStylesV19";
    style.textContent = `
      #entryThemeOptions.yuruneko-theme-list-v19 {
      ...
      #entryThemeOptions .yuruneko-theme-card-v19 {
        ...
        border: 1px solid rgba(109, 159, 173, 0.28) !important;
        border-radius: 18px !important;
        background: rgba(238, 248, 251, 0.84) !important;
      ...
      #entryThemeOptions .yuruneko-theme-check-v19 {
      ...
      #entryThemeOptions .yuruneko-theme-copy-v19 {
        display: grid !important;
        grid-template-columns: 1fr !important;
        gap: 5px !important;
        min-width: 0 !important;
      ...
      #entryThemeOptions .yuruneko-theme-name-v19 {
      ...
      #entryThemeOptions .yuruneko-theme-description-v19 {
        display: block !important;
        min-width: 0 !important;
        width: 100% !important;
        margin: 0 !important;
      ...
      #entryThemeOptions .yuruneko-theme-card-v19:has(
        .yuruneko-theme-check-v19:checked
      ) {
        border-color: rgba(67, 161, 182, 0.7) !important;
        background: rgba(214, 241, 247, 0.96) !important;
      }
